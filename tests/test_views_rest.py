...
def test_redirect_uri(app_rest, views_fixture_rest):
    """Test redirect uri."""
...
def test_login(app_rest, views_fixture_rest):
    """Test login."""
    with app_rest.test_client() as client:
        # Test redirect
        resp = client.get(
...
def test_invalid_authorized_response(app_rest, views_fixture_rest):
    """Test login."""
...
def test_state_token(app_rest, views_fixture_rest, monkeypatch):
    """Test state token."""
    # Mock session id
...
def test_no_remote_app(app_rest, views_fixture_rest):
    """Test no remote app."""
    with app_rest.test_client() as client:
        resp = client.get(
...
def test_token_getter_setter(app_rest, views_fixture_rest, monkeypatch):
...
def test_rejected(app_rest, views_fixture_rest, monkeypatch):
    """Test rejected."""
    # Mock session id
    monkeypatch.setattr('invenio_oauthclient._compat._create_identifier',
                        lambda: '1234')
