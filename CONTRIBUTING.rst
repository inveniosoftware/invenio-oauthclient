...
invenio-oauthclient could always use more documentation, whether as part of the
official invenio-oauthclient docs, in docstrings, or even on the web in blog
...
https://github.com/inveniosoftware/invenio-oauthclient/issues.
...
3. The pull request should work for Python 2.7, 3.3, 3.4 and 3.5. Check
   https://github.com/inveniosoftware/invenio-oauthclient/actions?query=event%3Apull_request
